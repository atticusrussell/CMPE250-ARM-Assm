...
MULT2		EQU 	1
			...
			MOVS R1,#13			;13
			RSBS R1,R1,#0		;-13
			ASRS R1,R1,#DIV4  	;-13/4 = -3 R1 so -3
			ADDS R0,R0,R1  		;51 + (-3) = 49
			
			
			;R0 <- 49 - (7 x 3)
			MOVS R2,#7    		;7
			LSLS R1,R2,#MULT2	;7x2=14
			ADDS R1,R1,R2		;7x3=21 aka 14+7 =21
			SUBS R0,R0,R1  		;49 - 21 = 27
			
			;R0 <- 27 - 65
			MOVS R1,#65     	;65
			SUBS R0,R0,R1  	;27-45 = -38
			
			
			;R0 <- -38 + 33
			MOVS R1, #33		;33
			ADDS R0,R0,R1		;-38 +33 = -5 =0xFFB
